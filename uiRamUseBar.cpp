...
void showRamUseBar()
{
  barRamUse = lv_bar_create(lv_scr_act());
  lv_obj_set_size(barRamUse, 210, 15);
  lv_obj_set_pos(barRamUse, 18, 286);
  lv_bar_set_value(barRamUse, ramUsagePrcnt, LV_ANIM_OFF);
